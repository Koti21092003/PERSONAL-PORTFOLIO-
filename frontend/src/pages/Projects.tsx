        ...
        <div className="max-w-7xl mx-auto relative z-20">
          ...
          >
            <div className="inline-block glass px-6 py-2 rounded-full mb-8 text-[11px] font-black uppercase tracking-widest text-indigo-400">
               Engineering Artifacts & Solutions
            </div>
            ...
            <p className="text-zinc-500 max-w-2xl mx-auto text-lg leading-relaxed font-medium mb-12 uppercase tracking-widest">
              A collection of architectural solutions designed for performance, scalabilty, and impact.
            </p>
          </motion.div>
          ...
          {loading ? (
             <div className="flex flex-col items-center justify-center py-40 gap-6">
                ...
                <p className="text-[10px] font-black text-indigo-500/50 uppercase tracking-[0.5em]">Syncing Neural Data...</p>
             </div>
          ) : (
